...
public class BankAccountServiceImpl implements BankAccountService {
	...
	@Override
	public boolean updateBankAccount(long accountId, String updatedName, String updatedType)throws BankAccountNotFoundException {
		boolean result= bankAccountdao.updateBankAccountDetails(accountId, updatedName, updatedType);
		if(result)
			DbUtil.commit();
		return result;
